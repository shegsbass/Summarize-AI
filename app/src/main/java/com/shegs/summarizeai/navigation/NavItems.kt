...
sealed class NavigationItem(var route: String, val icon: ImageVector? = null, var title: String? = null) {
    ...
    object SummarizeScreen : NavigationItem("summarizeScreen")

    object ResultScreen : NavigationItem("resultScreen")
}